          ...
          <div className='bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full max-w-[435px] p-10 mt-16'>
            ...
            <div>
              ...
              {errors?.firstName?.type === "required" && (
                <p className="my-2 text-red-500">This field is required</p>
              )}
              {errors?.firstName?.type === "maxLength" && (
                <p className="my-2 text-red-500">First name cannot exceed 20 characters</p>
              )}
              {errors?.firstName?.type === "pattern" && (
                <p className="my-2 text-red-500">Alphabetical characters only</p>
              )}
            </div>
            <div>
              <label
            ...
            <div className='mt-6 w-full'>
              ...
              <div>
                ...
                {errors?.password?.type === "minLength" && (
                    <p className="my-2 text-red-500">Password must be at least 8 characters</p>
                )}
                {errors?.password?.type === "maxLength" && (
                    <p className="my-2 text-red-500">Password maximum 20 characters</p>
                )}
                {errors?.password?.type === "pattern" && (
                    <p className="my-2 text-red-500">Password must be at least a symbol, upper and lower case letters and a number</p>
                )}
              </div>
            </div>
            <div className='mt-8'>
